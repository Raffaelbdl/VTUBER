...
public class FaceAnnotations : MonoBehaviour
{
    ...
    {
        VTuberSolution.onFaceLandmarksOutputSync += DrawNow;
        VTuberSolution.onFaceLandmarksOutputAsync += DrawPoseLandmarkListLater;
    }
    ...
    private void Awake()
    {
        _landmarkListAnnotation.Fill(478);
